...
(function () {
  ...
  p5.prototype.createGui = function (label, parent, x, y, provider) {
    label = label || "GUI";
    x = x || 0;
    y = y || 0;
    ...
    if (provider === "QuickSettings") {
      if (QuickSettings) {
        ...
        // QuickSettings.useExtStyleSheet("./quicksettings_white.css");
        gui = new QSGui(label, x, y, parent);
      } else {
        console.log(
  ...
  function QSGui(label, x, y, parent) {
